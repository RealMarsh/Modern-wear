...
?>
    ...
    <h2 class="heading">List of the items</h2>
    ...
    <h1></h1>
    <br>
    <input type="submit" name="submit" style="position:absolute;right:235px;margin-top: 2rem;border:1px solid green;height: 40px;width: 160px;"value="Go to Payment">
    </form>
